...
bool SignInScene::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           ...
                                           CC_CALLBACK_1(SignInScene::menuCloseCallback, this));
    
    closeItem->setPosition(Vec2(visibleSize.width*0.25,visibleSize.height *0.2));
    closeItem->setScale(2.0);
    
    
    auto closeItem_1 = MenuItemImage::create("fonts/CloseNormal.png","fonts/CloseSelected.png",CC_CALLBACK_1(SignInScene::menuCloseCallback_Gmail, this));
    ...
    auto closeItem_2 = MenuItemImage::create("fonts/CloseNormal.png",
                                             "fonts/CloseSelected.png",
                                             CC_CALLBACK_1(SignInScene::menuCloseCallback_LogOut, this));
...
void SignInScene::menuCloseCallback(Ref* pSender)
{
    SOCIAL_NETWORK->onFBSignIn();
}

void SignInScene::menuCloseCallback_Gmail(Ref* pSender)
{
    SOCIAL_NETWORK->onGoogleSignIn();
}


void SignInScene::menuCloseCallback_LogOut(Ref* pSender)
{
    SOCIAL_NETWORK->onFBSignOut();
    SOCIAL_NETWORK->onGoogleSignOut();
}

void SignInScene::didSignInFacebook(cocos2d::ValueMap infoFB){
    infoUser.clear();
    infoUser = infoFB;
...
void SignInScene::didSignInGmail(cocos2d::ValueMap infoGmail){
    infoUser.clear();
    infoUser = infoGmail;
